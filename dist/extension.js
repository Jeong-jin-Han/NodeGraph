...
<div id="toolbar">
  ...
  <span style="margin-left:auto;opacity:.35;font-size:10px">\uD5E4\uB354 \uB4DC\uB798\uADF8: \uB178\uB4DC\uC774\uB3D9 \xB7 \uBC30\uACBD \uB4DC\uB798\uADF8: \uD654\uBA74\uC774\uB3D9 \xB7 \uC2A4\uD06C\uB864: \uC90C \xB7 \uD5E4\uB354 \uD074\uB9AD: \uD558\uC704 \uC811\uAE30/\uD3BC\uCE58\uAE30</span>
</div>
<div id="viewport">
  <div id="canvas">
    <svg id="wire-svg">
          ...
          for (const node of data.nodes) {
            for (const img of node.images) {
              if (img.filename && !imageData[img.filename]) {
                try {
                  const imgUri = vscode2.Uri.joinPath(imgsFolder, img.filename);
